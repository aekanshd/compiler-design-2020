...
expression
    ...
    ;
for_stmt
	: FOR LPAREN assignment_expression SEMI simple_expression SEMI unary_expression RPAREN statement {}
    ...
    : INC_OP ID { 
                 ...
                 if(id_ex==NULL){
                    ...
                    if(strcmp(id_ex->dtype, "int")!=0){
                    	...
                    	sprintf(statement_type,"unary");
        
       					strcpy(temp,create_temp());
        				new_record = create_quadruple(statement_type," ","INC",$2,temp, yylineno); 
        				insert_quadruple(q_list1,new_record);
        				char te[20];
        				strcpy(te, "++");
        				strcat(te, $2);
                 ...
                 if(id_ex==NULL){
                    ...
                    if(strcmp(id_ex->dtype, "int")!=0){
                    	...
                    	sprintf(statement_type,"unary");
       					...
       					strcpy(temp,create_temp());
        				new_record = create_quadruple(statement_type," ","DEC",$2,temp, yylineno); 
        				insert_quadruple(q_list1,new_record);
        				char te[20];
        				strcpy(te, "--");
        				strcat(te, $2);
                 ...
                 if(id_ex==NULL){
                    ...
                    if(strcmp(id_ex->dtype, "int")!=0){
                    	...
                    	sprintf(statement_type,"unary");
       					...
       					strcpy(temp,create_temp());
        				new_record = create_quadruple(statement_type," ",$1,"DEC",temp, yylineno); 
        				insert_quadruple(q_list1,new_record);
        				strcat($1, "++");
